...
const nav = [
  ...
  { href: '/profit-calculator', label: 'Profit',     icon: Calculator },
]
  ...
  return (
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-black/8 flex items-center justify-between px-4 h-12">
        ...
        <button onClick={signOut} className="p-2 rounded-lg text-[#7a7974] hover:text-[#28251d] hover:bg-[#f3f0ec] transition-colors" aria-label="Sign out">
          <LogOut size={16} />
        </button>
      </header>

      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-black/8 flex"
